...
import classes from "../Register/stil.module.css";
...
const formFilled = [
  ...
  { id: "motivation_for_grant", filedName: "Motivation ", valid: false },
  { id: "impact_career", filedName: "Impact ", valid: false },
...
export default function ContactForm() {
  ...
  const validateExternalFactors = () => {
    // const regex = /^[1-9]$/;
    // const fieldOfStudyValid= regex.test(String(fieldOfStudy).toLowerCase());
    if (externalFactors.length < 1) {
  ...
  const validateHouseholdSurvey = () => {
    if (household) {
      formFilled[12].valid = true;
      return false;
    } else {
      formFilled[12].valid = false;
      return true;
    }
  };
  const validateAccommodationSurvey = () => {
    if (accommodation) {
      formFilled[13].valid = true;
      return false;
    } else {
      formFilled[13].valid = false;
      return true;
    }
  };
  ...
  return (
    <div style={{ width: "75%" }}>
      ...
      <div className="form-control">
        <div className="form-label">
          If you received the grant and/or got access to the Summit, how do you
          think that would impact your future career in STEM?*
        </div>
        <textarea
          id="impact_career"
          type="text"
      ...
      <div className="form-control">
        <div tabIndex="-1" id="household" className="form-label">
          Are you coming from a low-income household (less then 900BAM per
          household per month)?*
        </div>
        <Select
          instanceId="household_select"
          options={[
            { value: "Yes", label: "Yes" },
            { value: "No", label: "No" },
          ]}
          onChange={(e) => setHousehold(e.value)}
          placeholder="Select"
          required
          styles={classes.lista}
        />
      ...
      <div className="form-control">
        ...
        <Select
          instanceId="accommodatio_select"
          options={[
            { value: "Yes", label: "Yes" },
            { value: "No", label: "No" },
          ]}
