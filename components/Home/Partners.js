        ...
        <div className="container">
          ...
          >
            ...
            <SwiperSlide>
              <a
                target="_blank"
                href="https://www.porschebh.ba/"
                rel="noreferrer"
              >
                <img
                  className="sponsor-align"
                  src="/partners/PorscheBHallwhite.png"
                  alt="Sponsor Image"
                />
              </a>
            </SwiperSlide>
            ...
            <SwiperSlide>
              ...
              >
                <img
                  className="sponsor-align"
                  src="/partners/TehnogradCompany.png"
                  alt="Sponsor Image"
                />
              </a>
            </SwiperSlide>
            <SwiperSlide>
              <a
                target="_blank"
                href="https://www.bingotuzla.ba/"
                rel="noreferrer"
              >
                <img
                  className="sponsor-align"
                  src="/partners/bingo.png"
                  alt="Sponsor Image"
                />
              </a>
            </SwiperSlide>
            ...
            <SwiperSlide>
              <a
                target="_blank"
                href="https://bhwomen.org/en/home-eng/"
                rel="noreferrer"
              >
                <img
                  className="sponsor-align"
                  src="/partners/BWBH.png"
                  alt="Sponsor Image"
                />
              </a>
            </SwiperSlide>
            ...
            <SwiperSlide>
              <a
                target="_blank"
                href="https://www.bhfuturesfoundation.org/innovation-nation-2021"
                rel="noreferrer"
              >
                <img
                  className="sponsor-align"
                  src="/partners/IEEEBH-new.png"
                  alt="Sponsor Image"
                />
              </a>
            </SwiperSlide>
            <SwiperSlide>
              <a
                target="_blank"
                href="https://www.softhouse.se/en/kontakt/sarajevo/"
                rel="noreferrer"
              >
                <img
                  className="sponsor-align"
                  src="/partners/Softhouse.png"
                  alt="Sponsor Image"
                />
              </a>
            </SwiperSlide>
            ...
            <SwiperSlide>
              <a
                target="_blank"
                href="https://www.zendev.se/en"
                rel="noreferrer"
              >
                <img
                  className="sponsor-align"
                  src="/partners/ZenDev.png"
                  alt="Sponsor Image"
                />
              </a>
            </SwiperSlide>
            ...
            <SwiperSlide>
              <a
                target="_blank"
                href="http://www.bitcentar.com/"
                rel="noreferrer"
              >
                <img
                  className="sponsor-align"
                  src="/partners/bitcentar.png"
                  alt="Sponsor Image"
                />
              </a>
            </SwiperSlide>
            <SwiperSlide>
              <a
                target="_blank"
                href="https://citygecko.solar/"
                rel="noreferrer"
              >
                <img
                  className="sponsor-align"
                  src="/partners/citygecko.png"
                  alt="Sponsor Image"
                />
              </a>
            </SwiperSlide>
            ...
            <SwiperSlide>
              <a
                target="_blank"
                href=" http://www.fe.untz.ba/"
                rel="noreferrer"
              >
                <img
                  className="sponsor-align"
                  src="/partners/fetz.png"
                  alt="Sponsor Image"
                />
              </a>
            </SwiperSlide>
            ...
            <SwiperSlide>
              <a
                target="_blank"
                href="https://radiokameleon.ba/"
                rel="noreferrer"
              >
                <img
                  className="sponsor-align"
                  src="/partners/Kameleon.png"
                  alt="Sponsor Image"
                />
              </a>
            </SwiperSlide>
